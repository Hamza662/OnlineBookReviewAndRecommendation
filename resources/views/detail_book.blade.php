        ...
        <div class="col-md-12">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    ...
                    @if($book->cover_img != '')
                    <img src="{{asset('uploads/books/thumb/'.$book->cover_img)}}" alt="" class="card-img-top">
                ...
                <div class="col-md-8">
                    ...
                    <h5>Title: </h5><h3 class="h2 mb-3">{{$book->title}}</h3>
                    <h5>Author:</h5><div class="h4 text-muted">{{$book->author}}</div>
                    ...
                    <div class="content mt-3">
                       <h5>Publication Year: </h5> {{$book->publisher_year}}
                    </div>
                    @php
                    ...
                    @endphp
                    <div class="content mt-3">
                        <h5>Average Rating: </h5>{{number_format($avgRating,1)}}
                    </div>
                    ...
                    {{-- <div class="row mt-4">
                        ...
                        <div class="col-md-4 col-lg-4 mb-4">
                            <div class="card border-0 shadow-lg">
                                <img src="{{asset('images/book08.jpg')}}" alt="" class="card-img-top">
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="mb-3">{{$review->user->name}}</h4>
                                            <span
                                                class="text-muted">{{\Carbon\Carbon::parse($review->created_at)->format('d
                                                M , Y')}}</span>
                                    </div>
                                    @php
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Add Review for <strong>{{$book->title}}</strong>
                </h1>
